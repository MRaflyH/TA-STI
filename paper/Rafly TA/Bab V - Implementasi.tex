...
\begin{table}[!t]
  ...
  \begin{tabular}{ | l | p{0.55\textwidth} | }
    ...
    % BELUM DIVERIFIKASI -- keterangan sementara, tunggu konfirmasi pembimbing
    Chi square & Ukuran kecocokan penyelesaian lokasi; nilai yang lebih kecil berarti lokasi lebih konsisten \\
    ...
    % BELUM DIVERIFIKASI -- keterangan sementara, tunggu konfirmasi pembimbing
    Freedom & Derajat kebebasan penyelesaian lokasi \\
    % BELUM DIVERIFIKASI -- keterangan sementara, tunggu konfirmasi pembimbing
    Multi. & Jumlah sambaran susulan dalam satu kilat \\
